...
final class ZipUtil {
    ...
    private static ZipUtil.CentralDirectory findCentralDirectory(RandomAccessFile raf) throws IOException {
    ...
    /* Package visible for testing */
    private static long computeCrcOfCentralDir(RandomAccessFile raf, ZipUtil.CentralDirectory dir)
            throws IOException {
        CRC32 crc = new CRC32();
